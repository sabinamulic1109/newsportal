...
<?php 
	$idtext = $_GET['id'];
	$oglasiid = $idtext;
	include('include/counteroglasi.php');
	...
	$sql = "SELECT * from oglasi where id=$idtext"; 
	$result = mysqli_query ($con,$sql); 
	while($row = mysqli_fetch_array($result)){
...
<head>
    <meta charset="utf-8">
    <title>oglasiPortal - Free oglasi Website Template</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Free HTML Templates" name="keywords">
    <meta content="Free HTML Templates" name="description">
    <div  data-a2a-url="<?php echo $domenaXV; ?>/oglas.php?id=<?php echo $idtext; ?>" 
...
<body>
   ...
   <div class="container-fluid d-none d-lg-block">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-sm bg-dark p-0">
                    <ul class="navbar-nav ml-n2">
                        ...
                        <li class="nav-item border-right border-secondary">
                            <a class="nav-link text-body small" href="#">Kontakt</a>
                        </li>
                        <li class="nav-item">
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                ...
                <div class="input-group ml-auto d-none d-lg-flex" style="width: 100%; max-width: 300px;">
                    <input type="text" class="form-control border-0" placeholder="Traži..">
    ...
    <br>
    <!-- Breaking oglasi Start -->
    <?php 
				$sql = "SELECT * from oglasi where visible = 1 order by id desc limit 3"; 
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="login/oglasi/<?php echo $aboutphoto; ?>" style="object-fit: cover;">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="comments" style="color:black; "></div>
			...
			fetch("komentar.php?page_id=" + comments_page_id, {
                  ...
                  <!--  <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white text-center border border-top-0 p-3">
                            <a href=""><img class="img-fluid" src="login/oglasi/oglas.png" alt=""></a>
                        </div>
                    </div>
                    <!-- Ads End -->

                    <!-- Popular oglasi Start -->
                    <?php 
				$sql = "SELECT * from oglasi where visible = 1 order by id desc limit 9"; 
				$result = mysqli_query ($conn,$sql);
				$oglasi = array();	
				while($row = mysqli_fetch_array($result)){
					$oglasi[] = $row;
				...
				?>
                            <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                                <img class="img-fluid" style="width:100px;" src="login/oglasi/<?php echo $vijest['foto']; ?>" alt="">
                    ...
                    <div class="mb-3">
                        <div class="section-title mb-0">
                            <h4 class="m-0 text-uppercase font-weight-bold">oglasiletter</h4>
                        </div>
                        <div class="bg-white text-center border border-top-0 p-3">
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="row">
                <div class="col-4 mb-3">
                    <a href=""><img class="w-100" src="login/oglasi/ed.jpg" alt=""></a>
                </div>
                <div class="col-4 mb-3">
                    <a href=""><img class="w-100" src="login/oglasi/sr.png" alt=""></a>
                </div>
                <div class="col-4 mb-3">
                    <a href=""><img class="w-100" src="login/oglasi/geosoft.png" alt=""></a>
                </div>
                <div class="col-4 mb-3">
                    <a href=""><img class="w-100" src="login/oglasi/tesla.png" alt=""></a>
                </div>
                <div class="col-4 mb-3">
                    <a href=""><img class="w-100" src="login/oglasi/bhtelecom.png" alt=""></a>
                </div>
                <div class="col-4 mb-3">
                    <a href=""><img class="w-100" src="login/oglasi/amazon.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
