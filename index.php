...
<div class="text-truncate"><a class="text-white text-uppercase font-weight-semi-bold" href="single.php?id=<?php echo $vijest['id']; ?>">
    ...
    <?php 
				...
				?><?php 
				$sql1 = "SELECT * from oglasi where visible = 1 and position=0 order by id desc limit 1"; 
...
<hr>
    ...
    <div class="container-fluid pt-5 mb-3">
        <div class="container" >
            <div class="section-title">
                <h4 class="m-0 text-uppercase font-weight-bold">CRNA HRONIKA</h4>
            </div>
            <?php 
				$sql = "SELECT * from novosti where visible = 1 and zanr='crna hronika' order by id desc"; 
				$result = mysqli_query ($conn,$sql);
				$novosti = array();	
				while($row = mysqli_fetch_array($result)){
					$novosti[] = $row;
    ...
    <?php 
				$sql = "SELECT * from novosti where visible = 1  order by id desc"; 
				$result = mysqli_query ($conn,$sql);
				$novosti = array();	
				while($row = mysqli_fetch_array($result)){
					$novosti[] = $row;
    ...
    <div class="row py-4">
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="row">
                ...
                <div class="col-4 mb-3">
                    <a href=""><img class="w-100" src="login/news/geosoft.jfif" alt=""></a>
                </div>
                <div class="col-4 mb-3">
