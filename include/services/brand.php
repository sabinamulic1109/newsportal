...
<?php include "mobilenav.php" ?>
        ...
        <div class="pr__wrapper" id="site-wrapper" style="top: 0px;">
            ...
            <div class="pr__hero__wrap pr__dark serviceHeader" style="background-image: url('/assets/images/corp.jpg'); background-repeat: no-repeat; background-size: 1903px 1069px; background-position-y: calc(-193px);" id="site-hero">
        ...
        <div class="uk-container">
            <div class="section-inner">
                <div class="hero-content">
                    ...
                    <h2 class="page-title  uk-heading-primary"><?php echo $corporate['title']; ?><span class="service__header--span"><?php echo $corporate['titleSpan']; ?></span></h2>
                    <ul class="breadcrumbs uk-breadcrumb">
                        <li><a href="#"><?php echo $corporate['subTitle']; ?></a></li>
...
<div class="pr__content" id="brand">
                                ...
                                <div class="outer">
                                    <div class="inner">
                                        <div class="entry-body">
                                            ...
                                            <p><?php echo $corporate['body']; ?>
                                            </p>
                                            <p> <?php echo $corporate['bodySecond']; ?>
                                            </p>
                                           
										    
						<img src="assets/images/branding/ssBranding.jpg" alt="Brand Image" style="width:100%; height:auto;">
                        <img src="assets/images/branding/ssBranding1.jpg" alt="Brand Image" style="width:100%; height:auto;">
						<img src="assets/images/branding/ssBranding2.jpg" alt="Brand Image" style="width:100%; height:auto;">
						<img src="assets/images/branding/ssBranding3.jpg" alt="Brand Image" style="width:100%; height:auto;">
						<img src="assets/images/branding/ssBranding4.jpg" alt="Brand Image" style="width:100%; height:auto;">
		                                       </div>
                                    </div>
                                </div>
