...
<html lang="zxx" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <div id="loader" class="preloader pr__dark">
        ...
        <div class="pr__wrapper" id="site-wrapper" style="top: 0px;">
            ...
            <div class="pr__hero__wrap pr__dark serviceHeader" style="background-image: url('/assets/images/cloud.jpg'); background-repeat: no-repeat; background-size: 1903px 1069px; background-position-y: calc(-193px);" id="site-hero">
        ...
        <div class="uk-container">
            <div class="section-inner">
                <div class="hero-content">
                    ...
                    <h2 class="page-title  uk-heading-primary"><?php echo $cloud['title']; ?>  <span class="service__header--span"><?php echo $cloud['titleSpan']; ?></span></h2>
                    <ul class="breadcrumbs uk-breadcrumb">
                        <li><a href="#"> <?php echo $cloud['subTitle']; ?></a></li>
                                ...
                                <div class="outer">
                                    <div class="inner">
                                        <div class="entry-body">
                                            ...
                                            <p><?php echo $cloud['body']; ?>
                                            </p>
                                            <div class="row subtitle_area">
			  <div class="col-12">
			  <h5 class="uk-h4"><?php echo $cloud['tools']; ?></h5>
			  </div>
