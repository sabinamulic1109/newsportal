...
<html lang="zxx" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <div id="loader" class="preloader pr__dark">
        ...
        <div class="pr__wrapper" id="site-wrapper" style="top: 0px;">
            ...
            <div class="pr__hero__wrap pr__dark serviceHeader" style="background-image: url('/assets/images/support.jpg'); background-repeat: no-repeat; background-size: 1903px 1069px; background-position-y: calc(-193px);" id="site-hero">
        ...
        <div class="uk-container">
            <div class="section-inner">
                <div class="hero-content">
                    ...
                    <h2 class="page-title  uk-heading-primary"><?php echo $support['title']; ?>  <span class="service__header--span"><?php echo $support['titleSpan']; ?></span></h2>
                    <ul class="breadcrumbs uk-breadcrumb">
                        <li><a href="#"> <?php echo $support['subTitle']; ?></a></li>
                                ...
                                <div class="outer">
                                    <div class="inner">
                                        <div class="entry-body">
                                            ...
                                            <p><?php echo $support['body']; ?>
                                            </p>

                                            <p><?php echo $support['bodySecond']; ?>
                                            </p>
                                           
                                           
     <div class="row subtitle_area">
			  <div class="col-12">
			  <h5 class="uk-h4"><?php echo $support['tools']; ?></h5>
			  </div>
		  ...
		  <div class="row tools_row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-12 tools_col">
                        <div class="geosoft_box">
                            <img src="assets/images/tools/skype.png" alt="Skype">
                            <h3>Skype</h3>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-sm-12 tools_col">
                        <div class="geosoft_box">
                            <img src="assets/images/tools/email.png" alt="Email">
                            <h3>Email</h3>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-sm-12 tools_col">
                        <div class="geosoft_box">
                            <img src="assets/images/tools/teamviewer.png" alt="Teamviewer">
                            <h3>Teamviewer</h3>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-sm-12 tools_col">
                        <div class="geosoft_box">
                            <img src="assets/images/tools/tel.jpg" alt="Teamviewer">
                            <h3>Phone</h3>
                        </div>
                    </div>
