...
<div id="loader" class="preloader pr__dark">
   ...
   <?php include "include/services/mobilenav.php" ?>
        ...
        <div class="pr__wrapper" id="site-wrapper" style="top: 0px;">
            ...
            <div class="pr__hero__wrap pr__dark serviceHeader" style="background-image: url(&#39;assets/images/works/parkirajse/parkirajse_1.png&#39;); background-repeat: no-repeat; background-size: 1903px 1069px; background-position-y: calc(-193px);" id="site-hero">
        ...
        <div class="uk-container">
            <div class="section-inner">
                <div class="hero-content">
                    ...
                    <h2 class="page-title  uk-heading-primary"><?php echo $parkiraj['title']; ?><span class="service__header--span"><?php echo $parkiraj['titleSpan']; ?></span></h2>
                    <ul class="breadcrumbs uk-breadcrumb">
                        <li><a href="#"> <?php echo $parkiraj['subTitle']; ?></a></li>
                                ...
                                <div class="outer">
                                    <div class="inner">
                                        <div class="entry-body">
                                            ...
                                            <p><?php echo $parkiraj['body']; ?>
                                            </p>


                                            </div>
                                              </div>
                                              <h5 class="uk-h4"><?php echo $parkiraj['galleryTitle']; ?></h5>
                                             <div class="galerija row ">
                                               
                                            <a href="assets/images/works/parkirajse/parkirajse_1.png" class="big col-xl-4 col-lg-6 col-sm-12"> <img  class="galerija--img" src="assets/images/works/parkirajse/thumb/parkirajse_1.jpg" alt=""  /></a>
                                            <a href="assets/images/works/parkirajse/parkirajse_7.png" class="big col-xl-4 col-lg-6 col-sm-12"> <img  class="galerija--img" src="assets/images/works/parkirajse/thumb/parkirajse_7.jpg" alt=""  /></a>
                                            <a href="assets/images/works/parkirajse/parkiraj_2.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/parkirajse/thumb/parkiraj_2.jpg" alt=""  /></a>
                                            <a href="assets/images/works/parkirajse/parkiraj_3.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/parkirajse/thumb/parkiraj_3.jpg" alt=""  /></a>
                                            <a href="assets/images/works/parkirajse/parkiraj_4.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/parkirajse/thumb/parkiraj_4.jpg" alt=""  /></a>
                                            <a href="assets/images/works/parkirajse/parkiraj_5.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/parkirajse/thumb/parkiraj_5.jpg" alt=""  /></a>
                                            <a href="assets/images/works/parkirajse/parkiraj_6.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/parkirajse/thumb/parkiraj_6.jpg" alt=""  /></a>
                            ...
                            <div style="z-index: 1;" data-uk-sticky="offset: 120; bottom: true">
                                <section class="widget widget_nav_menu">
                                    ...
                                    <li> 
                                            ...
                                            <p><?php echo $parkiraj['clientName']; ?></p>
                                        </li>
                                        <li> 
                                            <h5><?php echo $workSidebar['typeTitle']; ?></h5>
                                            <p><?php echo $parkiraj['type']; ?></p>
                                        </li>
                                        <li> 
                                            <h5><?php echo $workSidebar['dateTitle']; ?></h5>
                                            <p><?php echo $parkiraj['date']; ?></p>
                                        </li>
                                        <li> 
                                            <h5><?php echo $workSidebar['webTitle']; ?></h5>
                                            <p><?php echo $parkiraj['websiteLink']; ?></p>
                                        </li>
