...
<div id="loader" class="preloader pr__dark">
   ...
   <?php include "include/services/mobilenav.php" ?>
        <div class="pr__wrapper" id="site-wrapper" style="top: 0px;">
            ...
            <div class="pr__hero__wrap pr__dark serviceHeader" style="background-image: url(&#39;assets/images/works/geoportal/geoportal_1.png&#39;); background-repeat: no-repeat; background-size: 1903px 1069px; background-position-y: calc(-193px);" id="site-hero">
        ...
        <div class="uk-container">
            <div class="section-inner">
                <div class="hero-content">
                    ...
                    <h2 class="page-title  uk-heading-primary"><?php echo $geoportal['title']; ?><span class="service__header--span"><?php echo $geoportal['titleSpan']; ?></span></h2>
                    <ul class="breadcrumbs uk-breadcrumb">
                        <li><a href="#"> <?php echo $geoportal['subTitle']; ?></a></li>
                                ...
                                <div class="outer">
                                    <div class="inner">
                                        <div class="entry-body">
                                            ...
                                            <p><?php echo $geoportal['body']; ?>
                                            </p>


                                            </div>
                                              </div>
                                              <h5 class="uk-h4"><?php echo $geoportal['galleryTitle']; ?></h5>
                                             <div class="galerija row ">
                                               
                                            <a href="assets/images/works/geoportal/geoportal_1.png" class="big col-xl-4 col-lg-6 col-sm-12"> <img  class="galerija--img" src="assets/images/works/geoportal/thumb/geoportal_1.jpg" alt=""  /></a>
                                            <a href="assets/images/works/geoportal/geoportal_2.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/geoportal/thumb/geoportal_2.jpg" alt=""  /></a>
                                            <a href="assets/images/works/geoportal/geoportal_3.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/geoportal/thumb/geoportal_3.jpg" alt=""  /></a>
                                            <a href="assets/images/works/geoportal/geportal_4.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/geoportal/thumb/geportal_4.jpg" alt=""  /></a>
                                            <a href="assets/images/works/geoportal/geoportal_5.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/geoportal/thumb/geoportal_5.jpg" alt=""  /></a>
                                            <a href="assets/images/works/geoportal/geoportal_6.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/geoportal/thumb/geoportal_6.jpg" alt=""  /></a>
                                            <a href="assets/images/works/geoportal/geoportal_7.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/geoportal/thumb/geoportal_7.jpg" alt=""  /></a>
                                            <a href="assets/images/works/geoportal/geoportal_8.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/geoportal/thumb/geoportal_8.jpg" alt=""  /></a>
                                ...
                                <section class="widget widget_nav_menu">
                                    ...
                                    <ul class="content">
                                       <li> 
                                            ...
                                            <p><?php echo $geoportal['clientName']; ?></p>
                                        </li>
                                        <li> 
                                            <h5><?php echo $workSidebar['typeTitle']; ?></h5>
                                            <p><?php echo $geoportal['type']; ?></p>
                                        </li>
                                        <li> 
                                            <h5><?php echo $workSidebar['dateTitle']; ?></h5>
                                            <p><?php echo $geoportal['date']; ?></p>
                                        </li>
                                        <li> 
                                            <h5><?php echo $workSidebar['webTitle']; ?></h5>
                                            <p><?php echo $geoportal['websiteLink']; ?></p>
                                        </li>
