...
<div id="loader" class="preloader pr__dark">
   ...
   <div class="pr__wrapper" id="site-wrapper" style="top: 0px;">
       ...
       <div class="pr__hero__wrap pr__dark serviceHeader" style="background-image: url(&#39;assets/images/works/inesa/inesa1.png&#39;); background-repeat: no-repeat; background-size: 1903px 1069px; background-position-y: calc(-193px);" id="site-hero">
   ...
   <div class="uk-container">
       <div class="section-inner">
           <div class="hero-content">
               ...
               <h2 class="page-title  uk-heading-primary"><?php echo $art['title']; ?><span class="service__header--span"><?php echo $art['titleSpan']; ?></span></h2>
               <ul class="breadcrumbs uk-breadcrumb">
                   <li><a href="#"> <?php echo $art['subTitle']; ?></a></li>
                               ...
                               <div class="inner">
                                   <div class="entry-body">
                                       ...
                                       <p><?php echo $art['body']; ?>
                                         ...
                                         <h5 class="uk-h4"><?php echo $art['galleryTitle']; ?></h5>
                                        <div class="galerija row">
                                          
                                       <a href="assets/images/works/inesa/inesa1.png" class="big col-xl-4 col-lg-6 col-sm-12"> <img  class="galerija--img" src="assets/images/works/inesa/thumb/inesa1.jpg" alt="" title="Beautiful Image" /></a>
                                       <a href="assets/images/works/inesa/inesa2.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/inesa/thumb/inesa2.jpg" alt="" title="Beautiful Image" /></a>
                                       <a href="assets/images/works/inesa/inesa3.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/inesa/thumb/inesa3.jpg" alt="" title="Beautiful Image" /></a>
                                       <a href="assets/images/works/inesa/inesa4.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/inesa/thumb/inesa4.jpg" alt="" title="Beautiful Image" /></a>
                           ...
                           <section class="widget widget_nav_menu">
                               ...
                               <ul class="content">
                                   <li> 
                                       ...
                                       <p><?php echo $art['clientName']; ?></p>
                                   </li>
                                   <li> 
                                       <h5><?php echo $workSidebar['typeTitle']; ?></h5>
                                       <p><?php echo $art['type']; ?></p>
                                   </li>
                                   <li> 
                                   ...
                                   <li> 
                                       ...
                                       <p><a target="_blank" href="<?php echo $art['websiteLink']; ?>"><?php echo $art['websiteLink']; ?></a></p>
                                   </li>
