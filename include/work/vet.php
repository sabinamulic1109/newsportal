...
<div id="loader" class="preloader pr__dark">
   ...
   <div class="pr__wrapper" id="site-wrapper" style="top: 0px;">
       ...
       <div class="pr__hero__wrap pr__dark serviceHeader" style="background-image: url(&#39;assets/images/works/vet/harba1.png&#39;); background-repeat: no-repeat; background-size: 1903px 1069px; background-position-y: calc(-193px);" id="site-hero">
   ...
   <div class="uk-container">
       <div class="section-inner">
           <div class="hero-content">
               ...
               <h2 class="page-title  uk-heading-primary"><?php echo $vet['title']; ?><span class="service__header--span"><?php echo $vet['titleSpan']; ?></span></h2>
               <ul class="breadcrumbs uk-breadcrumb">
                   <li><a href="#"> <?php echo $vet['subTitle']; ?></a></li>
                               ...
                               <div class="inner">
                                   <div class="entry-body">
                                       ...
                                       <p><?php echo $vet['body']; ?>
                                         ...
                                         <h5 class="uk-h4"><?php echo $vet['galleryTitle']; ?></h5>
                                        <div class="galerija row">
                                          
                                       <a href="assets/images/works/vet/harba1.png" class="big col-xl-4 col-lg-6 col-sm-12"> <img  class="galerija--img" src="assets/images/works/vet/thumb/harba1.jpg" alt="" title="Beautiful Image" /></a>
                                       <a href="assets/images/works/vet/harba2.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/vet/thumb/harba2.jpg" alt="" title="Beautiful Image" /></a>
                                       <a href="assets/images/works/vet/harba3.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/vet/thumb/harba3.jpg" alt="" title="Beautiful Image" /></a>
                                       <a href="assets/images/works/vet/harba4.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/vet/thumb/harba4.jpg" alt="" title="Beautiful Image" /></a>
                           ...
                           <section class="widget widget_nav_menu">
                               ...
                               <ul class="content">
                                   <li> 
                                       ...
                                       <p><?php echo $vet['clientName']; ?></p>
                                   </li>
                                   <li> 
                                       <h5><?php echo $workSidebar['typeTitle']; ?></h5>
                                       <p><?php echo $vet['type']; ?></p>
                                   </li>
                                   <li> 
                                       <h5><?php echo $workSidebar['dateTitle']; ?></h5>
                                       <p><?php echo $vet['date']; ?></p>
                                   </li>
                                   <li> 
                                       <h5><?php echo $workSidebar['webTitle']; ?></h5>
                                       <p><a target="_blank" href="<?php echo $vet['websiteLink']; ?>"><?php echo $vet['websiteLink']; ?></a></p>
                                   </li>
