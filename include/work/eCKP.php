...
<html lang="zxx" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <div id="loader" class="preloader pr__dark">
        ...
        <div class="pr__wrapper" id="site-wrapper" style="top: 0px;">
            ...
            <div class="pr__hero__wrap pr__dark serviceHeader" style="background-image: url(&#39;assets/images/works/eckp_1.png&#39;); background-repeat: no-repeat; background-size: 1903px 1069px; background-position-y: calc(-193px);" id="site-hero">
        ...
        <div class="uk-container">
            <div class="section-inner">
                <div class="hero-content">
                    ...
                    <h2 class="page-title  uk-heading-primary"><?php echo $eckp['title']; ?><span class="service__header--span"><?php echo $eckp['titleSpan']; ?></span></h2>
                    <ul class="breadcrumbs uk-breadcrumb">
                        <li><a href="#"> <?php echo $eckp['subTitle']; ?></a></li>
                                ...
                                <div class="outer">
                                    <div class="inner">
                                        <div class="entry-body">
                                            ...
                                            <p><?php echo $eckp['body']; ?>
                                            </p>


                                            </div>
                                              </div>
                                              <h5 class="uk-h4"><?php echo $eckp['galleryTitle']; ?></h5>
                                             <div class="galerija row">
                                               
                                            <a href="assets/images/works/eckp_1.png" class="big col-xl-4 col-lg-6 col-sm-12"> <img  class="galerija--img" src="assets/images/works/eckp-rsz.jpg" alt="" title="Beautiful Image" /></a>
                                            <a href="assets/images/works/eckp_2.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/eckp_2.png" alt="" title="Beautiful Image" /></a>
                                            <a href="assets/images/works/eckp_3.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/eckp_3.png" alt="" title="Beautiful Image" /></a>
                                            <a href="assets/images/works/eckp_4.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/eckp_4.png" alt="" title="Beautiful Image" /></a>
                                            <a href="assets/images/works/eckp_5.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/eckp_5.png" alt="" title="Beautiful Image" /></a>
                                ...
                                <section class="widget widget_nav_menu">
                                    ...
                                    <ul class="content">
                                        <li> 
                                            ...
                                            <p><?php echo $eckp['clientName']; ?></p>
                                        </li>
                                        <li> 
                                            <h5><?php echo $workSidebar['typeTitle']; ?></h5>
                                            <p><?php echo $eckp['type']; ?></p>
                                        </li>
                                        <li> 
                                            <h5><?php echo $workSidebar['dateTitle']; ?></h5>
                                            <p><?php echo $eckp['date']; ?></p>
                                        </li>
