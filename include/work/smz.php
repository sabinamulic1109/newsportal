...
<div id="loader" class="preloader pr__dark">
   ...
   <?php include "include/services/mobilenav.php" ?>
        ...
        <div class="pr__wrapper" id="site-wrapper" style="top: 0px;">
            ...
            <div class="pr__hero__wrap pr__dark serviceHeader" style="background-image: url(&#39;assets/images/works/smz/1.png&#39;); background-repeat: no-repeat; background-size: 1903px 1069px; background-position-y: calc(-193px);" id="site-hero">
        ...
        <div class="uk-container">
            <div class="section-inner">
                <div class="hero-content">
                    ...
                    <h2 class="page-title  uk-heading-primary"><?php echo $smz['title']; ?> <span class="service__header--span"><?php echo $smz['titleSpan']; ?></span></h2>
                    <ul class="breadcrumbs uk-breadcrumb">
                        <li><a href="#"> <?php echo $smz['subTitle']; ?> </a></li>
                                    ...
                                    <div class="inner">
                                        <div class="entry-body">
                                            ...
                                            <p><?php echo $smz['body']; ?>
                                              ...
                                              <h5 class="uk-h4"><?php echo $smz['galleryTitle']; ?></h5>
                                             <div class="galerija row ">
                                               
                                            <a href="assets/images/works/smz/1.png" class="big col-xl-4 col-lg-6 col-sm-12"> <img  class="galerija--img" src="assets/images/works/smz/thumb/1.jpg" alt=""  /></a>
                                            <a href="assets/images/works/smz/2.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/smz/thumb/2.jpg" alt=""  /></a>
                                            <a href="assets/images/works/smz/3.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/smz/thumb/3.jpg" alt=""  /></a>
                                            <a href="assets/images/works/smz/4.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/smz/thumb/4.jpg" alt=""  /></a>
                                            <a href="assets/images/works/smz/5.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/smz/thumb/5.jpg" alt=""  /></a>
                                            <a href="assets/images/works/smz/6.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/smz/thumb/6.jpg" alt=""  /></a>
