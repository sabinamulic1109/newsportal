...
<div id="loader" class="preloader pr__dark">
   ...
   <div class="pr__wrapper" id="site-wrapper" style="top: 0px;">
       ...
       <div class="pr__hero__wrap pr__dark serviceHeader" style="background-image: url(&#39;assets/images/works/acme/ad31.jpg&#39;); background-repeat: no-repeat; background-size: 1903px 1069px; background-position-y: calc(-193px);" id="site-hero">
   ...
   <div class="uk-container">
       <div class="section-inner">
           <div class="hero-content">
               ...
               <h2 class="page-title  uk-heading-primary"><?php echo $acme['title']; ?><span class="service__header--span"><?php echo $acme['titleSpan']; ?></span></h2>
               <ul class="breadcrumbs uk-breadcrumb">
                   <li><a href="#"> <?php echo $acme['subTitle']; ?></a></li>
                           ...
                           <div class="outer">
                               <div class="inner">
                                   <div class="entry-body">
                                       ...
                                       <p><?php echo $acme['body']; ?>
                                       </p>


                                       </div>
                                         </div>
                                         <h5 class="uk-h4"><?php echo $acme['galleryTitle']; ?></h5>
                                        <div class="galerija row">
                                          
                                       <a href="assets/images/works/acme/ad31.jpg" class="big col-xl-4 col-lg-6 col-sm-12"> <img  class="galerija--img" src="assets/images/works/acme/thumb/ad31.jpg" alt="" title="Beautiful Image" /></a>
                                       <a href="assets/images/works/acme/ad32.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/acme/thumb/ad32.jpg" alt="" title="Beautiful Image" /></a>
                                       <a href="assets/images/works/acme/ad33.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/acme/thumb/ad33.jpg" alt="" title="Beautiful Image" /></a>
                                       <a href="assets/images/works/acme/ad34.png" class="big col-xl-4 col-lg-6 col-sm-12"><img class="galerija--img"  src="assets/images/works/acme/thumb/ad34.jpg" alt="" title="Beautiful Image" /></a>
                           ...
                           <section class="widget widget_nav_menu">
                               ...
                               <ul class="content">
                                   <li> 
                                       ...
                                       <p><?php echo $acme['clientName']; ?></p>
                                   </li>
                                   <li> 
                                       <h5><?php echo $workSidebar['typeTitle']; ?></h5>
                                       <p><?php echo $acme['type']; ?></p>
                                   </li>
                                   <li> 
                                       <h5><?php echo $workSidebar['dateTitle']; ?></h5>
                                       <p><?php echo $acme['date']; ?></p>
                                   </li>
                                   <li> 
                                       <h5><?php echo $workSidebar['webTitle']; ?></h5>
                                       <p><a target="_blank" href="<?php echo $acme['websiteLink']; ?>"><?php echo $acme['websiteLink']; ?></a></p>
                                   </li>
