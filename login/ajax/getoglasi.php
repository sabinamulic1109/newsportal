...
$sql = "SELECT * from oglasi order by id desc LIMIT $dg, $gg"; 
...
<table width="100%" border="0" id="tableoglasi">
...
<?php foreach($rezultat as $r){ ?>
	...
	<tr>
		<td style="border-bottom: 1px solid rgb(153, 153, 153);">
			<img class="sliderslika" src="oglasi/<?php echo $r['foto']; ?>">
		</td>
		<td style="border-bottom: 1px solid rgb(153, 153, 153);">
		...
		<td style="border-bottom: 1px solid rgb(153, 153, 153);">
			<div class="nnP">
				<a href="cms.php?cms=oglasi2&&id=<?php echo $r['id']; ?>" style="color: rgb(255, 255, 255);">Edit</a>
			</div>
			<div class="nnD">
