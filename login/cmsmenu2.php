...
<?php
$idgr=$_GET["id"];
$sql = "SELECT * from grupe where id='$idgr'"; 
...
<h3 style="text-align:center;text-transform:uppercase">Edit menu item</h3>
<form action="updategr.php?id=<?php echo $idgr; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
