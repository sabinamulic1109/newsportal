...
<?php
	...
	$noid = $_GET["ID"];
	$sql = "SELECT * from customersPP where customer_id='$noid'"; 
	...
	$shname = $row["ship_customer_full_name"];
...
<form action="updatecustomersPP.php?id=<?php echo $idDok; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
<?php
...
<div class="col s12 m12" style="padding-left:0;padding-right:0">
	<label style="margin: 5px 0">Order ID:</label>	 
	<p><?php echo $orderID; ?></p>
</div>	 

<div class="col s12 m12" style="padding-left:0;padding-right:0">
	<label style="margin: 5px 0">Custopmer Paypal ID:</label>	 
	<p><?php echo $customerPPID; ?></p>
</div>	 
...
<div class="col s12 m12" style="padding-left:0;padding-right:0">
	<label style="margin: 5px 0">Shipping Name:</label>	 
	<input type="text" name="shname"  style="width:100%; height:40px; border:#941046 solid 1px; padding:5px; margin:5px 0;" title = "Shipping Name" placeholder = "Shipping Name" value="<?php echo $shname; ?>"> 
</div>	 
