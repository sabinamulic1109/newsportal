...
<?php
$ID=$_GET['ID'];
$sql = "SELECT * FROM ordersPP WHERE order_id=$ID";
...
<hr>
<b>Paypal Account ID:</b> <?php echo $row["order_paypal_accountID"]; ?><br>
<b>Paypal Order Number:</b> <?php echo $row["order_paypal_TNumber"]; ?><br>
</td>

<td style="vertical-align: top;width:50%;padding:20px">
<?php $customerId= $row["order_customerid"]; 

$sql1 = "SELECT * FROM customersPP WHERE customer_id=$customerId";
...
<hr>
<h2>Shipping</h2>
<b>Shipping Customer: </b> <?php echo $row1["ship_customer_full_name"]; ?> <br>
...
<hr>
<b>Last Order ID: </b> <?php echo $row1["orderID"]; ?><br>
<b>Customer Paypal ID: </b> <?php echo $row1["customerPPID"]; ?><br>
<?php } ?>
</td>
</tr>
<?php
...
$sql2="SELECT id,grupa,naziv,foto,cijena,discount,po_quantity,po_price FROM shop_artikli INNER JOIN poPP ON id = po_productid WHERE po_orderid=$ID";
