...
<?php
	...
	$fileDok = $row["foto"];
	$visible = $row['visible'];
	/* Create direct url to oglasi oglas - used for share oglasi on social media */
	$targeturl = $domenaXV.'/oglas.php?id='.$noid;
	/* Create direct url to oglasi oglas image - used for share oglasi on social media*/
	$imageurl = $domenaXV."/oglasi/".$fileDok; 
?>	

<div align="left">
<div class="col-sm-8 col-sm-offset-2">
<h3 style="text-align:center;text-transform:uppercase">Edit oglasi oglas</h3>

<div class="row" >
	<div class="col s12 m6" style="text-align:left"  >
		<h4 class="header" style="margin-bottom:10px">Visibility</h4>
		<div class="flat-toggle <?php if($visible == 1 ){echo ' on'; }?>" title="Change visibility of this oglas" >
			<?php if($visible == 1 ){ ?>
			<span id="visiblemsg">This oglas is visible on website</span>
			<?php }else{ ?>
			<span id="visiblemsg">This oglas is not visible on website</span>
			<?php } ?>
		</div>
	</div>
...
<form action="updateoglasi.php?id=<?php echo $idDok; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
<?php
...
<div class="col s12 m12" style="padding-left:0;padding-right:0">
	...
	<label style="margin: 5px 0">Link</label>	 

	<input type="text" name="podnaslov"  style="width:100%; height:40px; border:#941046 solid 1px; padding:5px; margin:5px 0;" title = "link" placeholder = "Link" value="<?php echo $podnaslovS; ?>"> 
...
<div class="col s12 m12" style="padding-left:0;padding-right:0">
	...
	<input type="file" name="photo1"  id="file" style="width:100%; height:40px; 
	 border:#941046 solid 1px; padding:5px; margin:5px 0;" onchange="loadFile(event)"> 
</div>	
...
<div class="imgShow">
	...
	<p style="text-align:center">
		<a href ="rotateimage.php?type=oglasi&id=<?php echo $idDok; ?>&degrees=90" title="Rotate counterclockwise">
			<i class="fas fa-undo" style="font-size:13px;color:#454545"></i>
		</a> 
		| 
		<a href ="rotateimage.php?type=oglasi&id=<?php echo $idDok; ?>&degrees=270" title="Rotate clockwise">
			<i class="fas fa-redo" style="font-size:13px;color:#454545"></i>
		</a>
	</p>
	<img id="output" width="100%" height="auto" style="margin-bottom:5px;" src="oglasi/<?php echo $fileDok; ?>">
	<?php	
	} ?>
</div>

<!-- <textarea name="tekst" id="editor" style="width:100%; height:402px; padding:5px; margin:5px;
 border:#CCCCCC solid 1px; border:#941046 solid 1px; padding:5px; margin:5px 0;"  
 placeholder="Description"><?php ?></textarea>-->
