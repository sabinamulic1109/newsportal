    ...
    <div class="container-fluid pt-5 mb-3">
        <div class="container" >
            <div class="section-title">
                <h4 class="m-0 text-uppercase font-weight-bold">REZULTATI VAŠE PRETRAGE</h4>
            </div>
            <?php

            if (isset($_GET['search'])) {
                $filtervalues = $_GET['search'];
                $query = "SELECT * FROM novosti WHERE CONCAT(naslov,podnaslov,tekst,zanr) LIKE '%$filtervalues%' ";
            ...
            <?php foreach ($query_run as $vijest) {
            ?>
                <div class="position-relative overflow-hidden" style="height: 300px;">
                    ...
                    <div class="position-relative overflow-hidden" style="height: 300px;">
                    <img class="img-fluid h-100" src="login/news/notfound.png" style="object-fit: cover;">
                    <div class="overlay">
                        <div class="mb-2">
                        </div>
                        <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" ><?php echo ('Nije pronađeno ništa što odgovara Vašoj pretrazi.');?></a>
...
while($row1 = mysqli_fetch_array($result)){
    ...
    foreach ($oglasi as $horizontalno) { ?>
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            src="login/oglasi/<?php echo $horizontalno['foto']; ?>" alt=""></a>
                        </div> <?php } ?>
